...
main = do
    ...
    let genOnesOnly = take 64 $ repeat (0.0::Double)
    ...
    let hundredOpponents = evalRand (randomGenomes 60 64 (-1.0::Double) (1.0::Double) ) g
    ...
    let evalsingletest = evalRand (mapM (\opps -> evaluate gen1 opps) sixtyBadOpponents) g

...
main = do
    ...
    let hundredOppsMinusToPlus  =   evalRand (randomGenomes 60 64 (-1.0::Double) (1.0::Double) ) g
    let hundredOppsPlusToPlus   =   evalRand (randomGenomes 60 64 (0.0::Double) (1.0::Double) ) g
